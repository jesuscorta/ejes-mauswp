...
[
			...
			[
				'key'           => 'field_mauswp_product_config_difference_note',
				'label'         => __( 'Nota diferencia Cota B - Cota A', 'mauswp' ),
				'name'          => 'mauswp_product_config_difference_note',
				'type'          => 'text',
				'instructions'  => __( 'Texto que aparece cuando ambos campos Cota A y Cota B están activos y hay una diferencia mínima configurada. Usa %s donde deba aparecer el número de milímetros.', 'mauswp' ),
				'default_value' => __( '* La diferencia entre Cota B y Cota A debe ser mayor de: %s mm', 'mauswp' ),
			],
				[
